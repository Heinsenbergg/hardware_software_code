...
def convert():
    ...
    system = int(input("Choice : "))   # User inputs the number of his 'system'
    print("\nChoose the system you want to convert your number to ")

    # Transform user's number and show the options of systems
    if system == 1:   # User input in binary
        temp = int(num, 2)
        print("[1] : Decimal \n[2] : Octal \n[3] : Hexadecimal \n[4] : Decimal, Octal, Hexadecimal (non negative)")
    elif system == 2: # User input in decimal
        temp = int(num)
        print("[1] : Binary \n[2] : Octal \n[3] : Hexadecimal \n[4] : Binary, Octal, Hexadecimal (non negative)")
    elif system == 3: # User input in octal
        temp = int(num, 8)
        print("[1] : Binary \n[2] : Decimal \n[3] : Hexadecimal \n[4] : Binary, Decimal, Hexadecimal (non negative)")
    elif system == 4: # User input in hexadecimal
        temp = int(num, 16)
